      ...
      <template v-if="store.activeGroup">
        <div v-if="showTaskBoard" class="gc-task-board">
          <div class="gc-task-header">
            <span><span v-html="ICON_SVG.clipboard"></span> 任务看板</span>
          ...
          <div class="gc-task-list">
            <div class="gc-task-empty">
              <p>暂无自动提取的任务。</p>
              <p class="gc-task-hint"><span v-html="ICON_SVG.lightbulb"></span> 开启"执行模式"并 @分配任务 后，Agent 的工作将在这里显示。</p>
            </div>
          </div>
        </div>
      </template>
      ...
      <div class="gc-modal-body">
        ...
        <div class="gc-presets-section">
          ...
          <div class="gc-preset-grid">
            ...
            >
              <span class="preset-icon" v-html="ICON_SVG[preset.icon] || ''"></span>
          ...
          <div v-for="(ad, i) in newAgents" :key="i" class="gc-agent-def">
            <div class="gc-agent-role-select">
              <button
                ...
                :title="role.name"
              >
                <span v-html="ICON_SVG[role.icon] || ''"></span>
              </button>
            </div>
      ...
      <div class="gc-modal-body">
        <div class="gc-role-section">
          ...
          <div class="gc-role-grid">
            ...
            >
              <div class="gc-role-icon" v-html="ICON_SVG[role.icon] || ''"></div>
...
// SVG icons for roles/presets (zero-emoji rule)
